...
#define MPU9250_RA_MAG_ADDRESS	0x0C<<1
...
#define MPU9250_ADDRESS_AD0_HIGH    0x69<<1 // address pin high (VCC)
...
//#define MS5611_ADDRESS                (0x76)<<1 // CSB is connected to HIGH(VCC)
#define MS5611_ADDRESS                (0x77)<<1 // CSB is connected to LOW(GND)
